...
series = default_benchmark_series(
    threshold_policy_name="Threshold-0.6",
    threshold_label="Tuned Threshold (0.6)",
)
...
output_dir = benchmark_output_dir(module_file=__file__, output_subdir="benchmark_15_150")
